      ...
      <main className="pt-24 md:pt-28 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold" data-testid="text-active-opportunities">{activeOpportunities}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold" data-testid="text-investors-count">{investorsLoading ? "..." : investors.length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold" data-testid="text-business-owners-count">{businessOwnersLoading ? "..." : businessOwners.length}</div>
              <p className="text-xs text-muted-foreground">For networking</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold" data-testid="text-partnerships-count">{partnershipsLoading ? "..." : partnershipOpportunities.length}</div>
